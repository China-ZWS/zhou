...
- (UICollectionViewFlowLayout *)segmentBarLayout
{
    if (!_segmentBarLayout) {
        ...
        _segmentBarLayout.itemSize = CGSizeMake(self.view.frame.size.width / _viewControllers.count, SEGMENT_BAR_HEIGHT - 1);
...
- (UIView *)indicatorBgView
{
    if (!_indicatorBgView)
    {
        CGRect frame = CGRectMake(5, self.segmentBar.frame.size.height - INDICATOR_HEIGHT - 1,
                                  CGRectGetWidth(self.view.frame) / self.viewControllers.count - 10, INDICATOR_HEIGHT);
